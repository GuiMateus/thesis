...
def bbox2points(bbox):
    ...
    """
    x, y, w, h = bbox
    if not x > 10000 and not y > 10000 and not w > 10000 and not h > 10000:
...
def load_network(config_file, data_file, weights, batch_size=1):
    ...
    class_names = [metadata.names[i].decode(
        "ascii", 'ignore') for i in range(metadata.classes)]
...
if os.name == "nt":
    ...
    lib = CDLL(
        "/home/gui/Documents/rob9/src/master/vision/pythonClasses/darknet/libdarknet.so", RTLD_GLOBAL)
